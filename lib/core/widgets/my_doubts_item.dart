...
import 'package:zifour_sourcecode/core/widgets/full_image_viewer_screen.dart';
...
class MyDoubtsItem extends StatelessWidget {
  ...
  String? subject;
  Function()? itemClick;
  MyDoubtsItem({super.key, this.title, this.isReplied, this.itemClick, this.imageUrl, this.subject});
